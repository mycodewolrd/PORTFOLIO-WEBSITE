    ...
    <div className="min-h-screen relative overflow-hidden flex flex-col items-center">
      ...
      >
        ...
        >
          ...
          <div className="absolute -z-10 w-72 h-72 bg-gradient-to-br from-purple-600 to-pink-500 rounded-full blur-3xl opacity-60 bottom-[-50px] left-[-10] md:top-10 md:right-10 "></div>
